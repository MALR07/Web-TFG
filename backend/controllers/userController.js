...
module.exports = {
  ...
  createUsuario: [verifyToken, checkRole('camarero'), async (req, res) => {
    ...
    try {
      ...
      await sendEmail(newUser.email, 'Bienvenido a nuestro servicio', `Hola ${newUser.nombre}, tu cuenta ha sido creada exitosamente.`);
  ...
  updateUsuario: [verifyToken, checkRole('camarero'), async (req, res) => {
    ...
    try {
      ...
      await user.update({ nombre, email, contrasena: user.contrasena, rol });

      // Enviar correo de confirmación
      await sendEmail(user.email, 'Datos de Usuario Actualizados', `Hola ${user.nombre}, tus datos han sido actualizados exitosamente.`);
